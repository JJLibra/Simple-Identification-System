...
class StartMainUi(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle("xxfer的智能识别系统")
        MainWindow.setWindowIcon(QIcon('./img/luckycat.ico'))
        ...
        self.Title_label.setStyleSheet("QLabel{color:#F8FCFF;font-size:50px;font-weight:bold;font-family:Roman times;}")
    ...
    def retranslateUi(self, Form):
        ...
        self.Title_label.setText(_translate("Form", "——智能识别系统——"))
        self.user_button.setText(_translate("Form", "用户登录"))
        self.admin_button.setText(_translate("Form", "用户注册"))
